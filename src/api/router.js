...
const routes = [
  ...
  { method: 'POST', pattern: new URLPattern({ pathname: BASE_PATH + '/api/groups' }), handler: groups.create },
  { method: 'GET', pattern: new URLPattern({ pathname: BASE_PATH + '/api/groups/:id' }), handler: groups.detail },
  { method: 'GET', pattern: new URLPattern({ pathname: BASE_PATH + '/api/groups/:id/members/form' }), handler: members.form },
  { method: 'POST', pattern: new URLPattern({ pathname: BASE_PATH + '/api/groups/:id/members' }), handler: members.add },
  { method: 'GET', pattern: new URLPattern({ pathname: BASE_PATH + '/api/groups/:id/expenses/form' }), handler: expenses.form },
